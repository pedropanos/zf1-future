...
This fork is maintained to keep ZF1 compatible with PHP 8.2 and PHP 8.4 while preserving compatibility with legacy codebases.
...
*  [ZF1 Extras Future Fork](https://github.com/pedropanos/zf1-extras-future)
